...
import cn.cnlee.commons.view.Banner;

public class GDTBannerViewManager extends SimpleViewManager implements BannerADListener {
    ...
    public void setShowCloseBtn(FrameLayout view, final boolean showCloseBtn) {
        if (mBanner != null) mBanner.setShowCloseBtn(showCloseBtn);
    }
}
