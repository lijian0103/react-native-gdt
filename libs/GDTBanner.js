...
const RNGDTBanner = requireNativeComponent("GDTBanner", GDTBanner);

export default class GDTBanner extends PureComponent {
    ...
    static propTypes = {
         ...
         *  Banner条展示关闭按钮，默认打开
         */
        showCloseBtn: PropTypes.bool, //需要写在appInfo属性之前才能生效
        /**
         *  请求广告条数据成功后调用
    ...
    render() {
        return <RNGDTBanner {...this.props} onFailToReceived={this._onFailToReceived.bind(this)}/>;
    }
}